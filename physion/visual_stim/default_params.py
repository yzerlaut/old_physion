...
STIMULI = {
    ...
    "Natural-Image+VSE":{
        ...
        "min-saccade-duration (s)":3.,
        "max-saccade-duration (s)":3.,
        ...
        "min-saccade-duration-1":0.1,"min-saccade-duration-2":2,"N-min-saccade-duration":0,
        "max-saccade-duration-1":0.1,"max-saccade-duration-2":10,"N-max-saccade-duration":0,
    ...
    "line-moving-dots":{
        ...
        "direction-1": 0, "direction-2": 360, "N-direction": 0,
    ...
    # looming stim
    "looming-stim":{
        "radius-start (deg)":0.5, "radius-end (deg)":100,
        "x-center (deg)":0, "y-center (deg)":0,
        "looming-duration (s)":2,
        "looming-nonlinearity ()":3,
        "end-duration (s)": 0.5,
        "color (lum.)":-1,
        "bg-color (lum.)":0.5,
        "radius-start-1":0., "radius-start-2":120, "N-radius-start":0,
        "radius-end-1":0., "radius-end-2":500., "N-radius-end":0,
        "x-center-1":-200, "x-center-2":200, "N-x-center":0,
        "y-center-1":-200., "y-center-2":200., "N-y-center":0,
        "looming-nonlinearity-1": 0.01, "looming-nonlinearity-2": 100., "N-looming-nonlinearity": 0,
        "looming-duration-1": 0., "looming-duration-2": 5., "N-looming-duration": 0,
        "end-duration-1": 0., "end-duration-2": 5., "N-end-duration": 0,
        "bg-color-1": 0., "bg-color-2": 1., "N-bg-color": 0,
        "color-1": -1, "color-2": 1, "N-dotcolor": 0,
    },
