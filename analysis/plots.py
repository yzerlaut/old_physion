...
def raw_data_plot(self, tzoom):
    ...
    if self.Screen is not None:
        ...
        self.plot.plot(self.Screen['times'][cond][::isampling], y,
        ...
        self.plot.plot([tzoom[0], tzoom[1]],
                       shift(self, 0)+np.zeros(2))
    ...
    ## -------- Calcium --------- ##
    pen = pg.mkPen(color=(100, 255, 100))
